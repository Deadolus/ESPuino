...
#ifdef I2C_2_ENABLE
	pinMode(ext_IIC_CLK, OUTPUT_OPEN_DRAIN);
	pinMode(ext_IIC_DATA, OUTPUT_OPEN_DRAIN);
    digitalWrite(ext_IIC_DATA, LOW);
  	delayMicroseconds(5);
  	digitalWrite(ext_IIC_CLK, HIGH);
  	delayMicroseconds(2);
  	digitalWrite(ext_IIC_DATA, HIGH);
  	delayMicroseconds(2);
