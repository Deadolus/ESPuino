...
#define RFID_READER_TYPE_PN532_I2C
	...
	*/
	// *****BUTTON*****        *****ACTION*****
	#define BUTTON_0_SHORT    CMD_SEEK_BACKWARDS
	...
	#define BUTTON_0_LONG     CMD_PREVTRACK
	...
	#define BUTTON_MULTI_24   CMD_TELL_IP_ADDRESS
	#define BUTTON_MULTI_25   CMD_ENABLE_FTP_SERVER
