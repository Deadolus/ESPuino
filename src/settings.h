...
#define RFID_READER_TYPE_PN532_I2C
	...
	*/
	// *****BUTTON*****        *****ACTION*****
	#define BUTTON_0_SHORT    CMD_SEEK_FORWARDS
	...
	#define BUTTON_MULTI_03   CMD_VOLUMEUP
	#define BUTTON_MULTI_04   CMD_NOTHING
	#define BUTTON_MULTI_05   CMD_NOTHING
	#define BUTTON_MULTI_12   CMD_TELL_IP_ADDRESS
	#define BUTTON_MULTI_13   CMD_NOTHING
	#define BUTTON_MULTI_14   CMD_TOGGLE_BLUETOOTH_SINK_MODE
	#define BUTTON_MULTI_15   CMD_TOGGLE_BLUETOOTH_SOURCE_MODE
	...
	#if defined(RFID_READER_TYPE_MFRC522_I2C) || defined(PORT_EXPANDER_ENABLE) || defined(MEASURE_BATTERY_MAX17055) || defined(RFID_READER_TYPE_PN532_I2C) || defined(RFID_READER_TYPE_PN532_SPI)
		#define I2C_2_ENABLE
	#endif
